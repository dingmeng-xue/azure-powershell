...
namespace Microsoft.Azure.Commands.WebApps.Helper.Network.Models
{
    ...
    public partial class Subnet : SubResource
    {
        ...
        /// policies.</param>
        /// <param name="privateEndpointsProperty">An array of references to
        /// private endpoints.</param>
            ...
            : base(id)
        {
            ...
            PrivateEndpointsProperty = privateEndpointsProperty;
        ...
        public IList<PrivateEndpoint> PrivateEndpointsProperty { get; private set; }
