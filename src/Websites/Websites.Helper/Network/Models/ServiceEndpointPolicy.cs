...
namespace Microsoft.Azure.Commands.WebApps.Helper.Network.Models
{
    ...
    public partial class ServiceEndpointPolicy : Resource
    {
        ...
        /// policy.</param>
        /// <param name="subnetsProperty">A collection of references to
        /// subnets.</param>
        ...
        public ServiceEndpointPolicy(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), IList<ServiceEndpointPolicyDefinition> serviceEndpointPolicyDefinitions = default(IList<ServiceEndpointPolicyDefinition>), IList<Subnet> subnetsProperty = default(IList<Subnet>), string resourceGuid = default(string), string provisioningState = default(string), string etag = default(string))
        ...
        public IList<Subnet> SubnetsProperty { get; private set; }
