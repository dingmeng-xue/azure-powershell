...
namespace Microsoft.Azure.Commands.WebApps.Helper.PrivateDns
{
    ...
    /// </summary>
    public partial interface IRecordSets
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<RecordSet>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string privateZoneName, RecordType recordType, string relativeRecordSetName, RecordSet parameters, string ifMatch = default(string), string ifNoneMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
