...
#pragma warning restore CA1001 // Types that own disposable fields should be disposable
    {
        ...
        public TokenCache(AzureIdentity.TokenCachePersistenceOptions options = null)
            : this(options, default, default)
        { }

        internal TokenCache(AzureIdentity.TokenCachePersistenceOptions options, MsalCacheHelperWrapper cacheHelperWrapper, Func<IPublicClientApplication> publicApplicationFactory = null)
        {
            ...
            if (options is InMemoryTokenCacheOptions inMemoryOptions)
            {
                TokenCacheUpdatedAsync = inMemoryOptions.TokenCacheUpdatedV2Async;
                RefreshCacheFromOptionsAsync = inMemoryOptions.RefreshCacheV2Async;
        ...
        /// </summary>
        internal Func<AzPSTokenCacheUpdatedArgs, Task> TokenCacheUpdatedAsync;
        ...
        private async Task UpdateCacheDataAsync(ITokenCacheSerializer tokenCache)
        {
            ...
            try
            {
                ...
                if (TokenCacheUpdatedAsync != null)
                {
                    ...
                    await TokenCacheUpdatedAsync(new AzPSTokenCacheUpdatedArgs(eventBytes)).ConfigureAwait(false);
                }
