...
online version: https://docs.microsoft.com/powershell/module/az.quota/get-azrequest
schema: 2.0.0
---
...
### List (Default)
```
Get-AzRequest -Scope <String> [-Filter <String>] [-Skiptoken <String>] [-Top <Int32>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzRequest -Id <String> -Scope <String> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzRequest -InputObject <IQuotaIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```
